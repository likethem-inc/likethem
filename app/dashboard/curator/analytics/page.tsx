...
export default function AnalyticsPage() {
  ...
  const metrics: AnalyticsMetric[] = [
    {
      label: t('analytics.metrics.storeVisits'),
      value: '12,847',
      change: '+23%',
      trend: 'up',
    ...
    {
      label: t('analytics.metrics.itemsFavorited'),
      value: '1,234',
      change: '+18%',
      trend: 'up',
    ...
    {
      label: t('analytics.metrics.productsSold'),
      value: '89',
      change: '+12%',
      trend: 'up',
  ...
  const metricLabels: Record<string, string> = {
    views: t('analytics.charts.views'),
    favorites: t('analytics.charts.favorites'),
    sales: t('analytics.charts.sales'),
  }
      ...
      <div className="container-custom max-w-7xl">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-serif text-3xl font-light mb-2">{t('analytics.title')}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="font-serif text-xl font-light">{t('analytics.charts.traffic')}</h2>
          ...
          >
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h2 className="font-serif text-xl font-light mb-6">{t('analytics.topProducts')}</h2>
                  ...
                  <div key={index} className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-gray-500">
                        <span>{product.views} {t('analytics.topProducts.views')}</span>
                        <span>{product.favorites} {t('analytics.topProducts.fav')}</span>
                        <span>{product.sales} {t('analytics.topProducts.sales')}</span>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <h2 className="font-serif text-xl font-light">{t('analytics.demographics.cities')}</h2>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <h2 className="font-serif text-xl font-light">{t('analytics.demographics.devices')}</h2>
              </div>
        ...
        >
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="font-serif text-xl font-light mb-6">{t('analytics.funnel.title')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-medium text-carbon mb-1">{t('analytics.funnel.storeVisits')}</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-medium text-carbon mb-1">{t('analytics.funnel.favorites')}</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-medium text-carbon mb-1">{t('analytics.funnel.sales')}</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-medium text-carbon mb-1">{t('analytics.funnel.revenue')}</h3>
