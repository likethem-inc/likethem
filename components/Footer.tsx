    ...
    <footer className="bg-carbon text-white py-16">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-medium mb-4">{t('footer.nav.title')}</h4>
            <ul className="space-y-2 text-sm text-gray-300">
              <li><Link href="/explore" className="hover:text-white transition-colors">{t('footer.nav.stores')}</Link></li>
              <li><Link href="/explore" className="hover:text-white transition-colors">{t('footer.nav.curators')}</Link></li>
              <li><Link href="/explore" className="hover:text-white transition-colors">{t('footer.nav.collections')}</Link></li>
              <li><Link href="/explore" className="hover:text-white transition-colors">{t('footer.nav.trending')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><Link href="/terms-of-service" className="hover:text-white transition-colors">{t('footer.company.terms')}</Link></li>
            </ul>
          </div>
        </div>
